...
$cmd = "call `"$($vcvars.FullName)`" >nul && cl /nologo /W4 /WX /I`"$root\src\proto`" /I`"$root\src\app`" /I`"$root\src\hal`" /I`"$root\src\common`" /I`"$root\tools\sim`" " +
